...
angular.module('YtelAPILib')
    ...
    function PhoneNumberController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
             ...
             *
             * @param {NumberType2Enum} numberType The capability the number supports.
             ...
             * @param {NumberTypeEnum|null} numberType [Optional] The capability supported by the number.Number
             ...
             * @return {promise<String>}
             */
            createReleaseNumber: function (phoneNumber) {
                ...
                //prepare query string for API call
                var _baseUri = Configuration.BASEURI;
                var _queryBuilder = _baseUri + '/incomingphone/releasenumber.json';
             ...
             *
             * @param {Numbertype1Enum} numbertype Number type either SMS,Voice or all
             * @param {string} areacode Specifies the area code for the returned list of available numbers. Only
             * available for North American numbers.
