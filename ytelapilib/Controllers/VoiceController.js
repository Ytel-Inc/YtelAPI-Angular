...
angular.module('YtelAPILib')
    .factory('VoiceController', ['$q', 'Configuration', 'HttpClient', 'APIHelper', 'BaseController', VoiceController
    ]);

    function VoiceController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
             ...
             * @return {promise<String>}
             */
            createViewCallDetails: function (callSid) {
             ...
             * @param {Status1Enum|null} status [Optional] Status to set the in-progress call to
             *
             * @return {promise<String>}
             */
             ...
             * @param {Direction1Enum|null} direction [Optional] The leg of the call audio will be played to
             ...
             * @param {DirectionEnum|null} direction [Optional] The leg of the call to record
             ...
             * separated with comma. e.g : +12223334444,+15556667777
